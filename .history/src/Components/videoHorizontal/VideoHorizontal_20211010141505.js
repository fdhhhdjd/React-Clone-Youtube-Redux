    ...
    <>
      <Row className="py-2 m-1 videoHorizontal align-align-items-center">
        <Col xs={6} md={4} className="videoHorizontal__left">
          ...
          <span className="videoHorizontal__duration video__top__duration">
            {_duration}
          </span>
        </Col>
        <Col xs={6} md={8} className="p-0 videoHorizontal__right">
          <p className="mb-1 videoHorizontal__title">
            elements must have a unique title property elements must have a
            unique title property elements must have a unique title property
            elements must have a unique title property{" "}
          </p>
